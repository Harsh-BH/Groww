...
const Footer = () => {
  return (
    <footer className="relative bg-[#F8F4EF] pt-8 pb-6 h-[90vh] flex justify-center items-center">
      ...
      <div className="w-[600px] h-[400px] bg-white text-black rounded-3xl bg-opacity-30 backdrop-blur-xl flex flex-col justify-center items-center gap-6">
